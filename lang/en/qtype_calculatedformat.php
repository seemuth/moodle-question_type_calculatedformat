...
$string['correctanswerbaseformat'] = 'Correct answer base and format';
$string['correctanswerformula'] = 'Correct answer formula';
$string['correctanswerlengthint'] = 'Number of integer digits';
$string['correctanswerlengthint_help'] = 'Number of digits before the decimal (or radix) point. Specify 0 for as many digits as needed, or positive for exact number of digits in base 2, 8, or 16 (automatically masked to specified number of digits).';
$string['correctanswerlengthfrac'] = 'Fractional digits';
$string['correctanswerlengthfrac_help'] = 'Number of digits after the decimal (or radix) point';
$string['correctanswershowbase'] = 'Show base?';
$string['correctanswershowbase_help'] = 'Indicate base when displaying correct answer? Prefixes are 0b, 0o, 0d, and 0x. Subscripts are shown after the number, e.g., 1234<sub>10</sub>.';
...
$string['decimal'] = 'Decimal (base 10)';
...
$string['groupdigits'] = 'Group integer digits?';
$string['groupdigits_help'] = 'When displaying the correct answer, optionally group integer digits (digits to the left of the decimal or radix point) by thousands or groups of 4 digits.';
$string['groupfour'] = 'Groups of four digits separated by \'{$a}\'';
$string['groupthree'] = 'Groups of three digits separated by \'{$a}\'';
$string['hexadecimal'] = 'Hexadecimal (base 16)';
...
$string['max'] = 'Max';
$string['min'] = 'Min';
$string['mindigits'] = 'Minimum number of integer digits';
$string['minexactdigits'] = 'Minimum or exact number of digits';
$string['minexactdigits_help'] = 'This applies only to binary, octal, and hexadecimal bases. If minimum, then all formatted formulas and correct answers will be displayed with at least the given number of integer digits (digits to the left of the radix point). If exact, then all formatted formulas and correct answers will be displayed with exactly the given number of integer digits. All such values will be masked to the correct number of bits/digits.';
$string['minmax'] = 'Range of Values';
$string['missingcorrectanswerlength'] = 'Missing correct answer length';
...
$string['requirebase'] = 'Require answers in base';
$string['requirebase_help'] = 'Require answers to be in the specified base. If any base is acceptable, answers should begin with a prefix, i.e., 0b for binary, 0o for octal, 0d for decimal, or 0x for hexadecimal.';
...
$string['showbaseasprefix'] = 'Show base as prefix';
$string['showbaseassubscript'] = 'Show base as subscript';
