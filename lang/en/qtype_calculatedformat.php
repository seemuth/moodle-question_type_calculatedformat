...
$string['correctanswerlengthint'] = 'Minimum/exact integer digits';
$string['correctanswerlengthint_help'] = 'Minimum (or exact) number of digits before the decimal (or radix) point';
