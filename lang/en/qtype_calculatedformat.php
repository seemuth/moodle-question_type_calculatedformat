...
$string['requireexactdigits'] = 'Require exact number of digits?';
$string['requireexactdigits_help'] = 'Should student answers be required to have exactly the correct number of digits? If so, answers will be marked as invalid if they do not have the correct number of digits.';
$string['requireexactdigitsillegalbase'] = 'Base must be specified in order to require exact number of digits.';
$string['requireexactdigitsillegallength'] = 'Number of integer digits must be positive in order to require exact number of digits.';
